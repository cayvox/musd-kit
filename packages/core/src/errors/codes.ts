...
export const MusdErrorCode = {
  ...
  REDEMPTION_PRICE_FRAGILE: 'REDEMPTION_PRICE_FRAGILE',
  LAST_TROVE_IN_SYSTEM: 'LAST_TROVE_IN_SYSTEM',
  ...
  // MK-105. `PriceFeed.fetchPrice` refuses a round older than 60 seconds (`PriceFeed.sol:14`, `:51-54`).
